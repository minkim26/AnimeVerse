> Archived from the project's root `README.md` (previously misused as the top-level readme). Documents the profile-image microservice under `anime-verse-backend/microserviceA/CS361_microserviceA/`.
